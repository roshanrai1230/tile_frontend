...
const CheckoutPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("https://tile-backend-6xtp.onrender.com/api/orders", orderData);
            setOrderPlaced(true);
            clearCart();
        } catch (err) {
            ...
            <div className="flex flex-col lg:flex-row gap-12">
                ...
                <div className="lg:w-2/3">
                    <form onSubmit={handleSubmit} className="space-y-8">
                        {/* Shipping Address */}
                        <div className="bg-white border border-gray-100 rounded-none p-8 sm:p-10 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-gray-50 border border-gray-200 rounded-none px-6 py-4 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all italic"
                                ...
                                <div className="md:col-span-2 space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-gray-50 border border-gray-200 rounded-none px-6 py-4 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all italic resize-none"
                        ...
                        <div className="bg-white border border-gray-100 rounded-none p-8 sm:p-10 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <label
                                    className={`flex items-center gap-4 p-6 rounded-none border-2 cursor-pointer transition-all ${formData.paymentMethod === 'COD'
                                ...
                                >
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                    />
                                    <div className={`w-12 h-12 rounded-none flex items-center justify-center transition-all ${formData.paymentMethod === 'COD' ? "bg-blue-600 text-white" : "bg-white text-gray-400 border border-gray-100"}`}>
                                    ...
                                    <div className={`ml-auto w-5 h-5 rounded-none border-4 flex items-center justify-center ${formData.paymentMethod === 'COD' ? "border-blue-600 bg-white" : "border-gray-200"}`}>
                                        {formData.paymentMethod === 'COD' && <div className="w-1.5 h-1.5 bg-blue-600 rounded-none" />}
                                    </div>
                                </label>

                                <label
                                    className={`flex items-center gap-4 p-6 rounded-none border-2 cursor-pointer transition-all ${formData.paymentMethod === 'ONLINE'
                                        ? "border-blue-600 bg-blue-50/50"
                                ...
                                >
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                    />
                                    <div className={`w-12 h-12 rounded-none flex items-center justify-center transition-all ${formData.paymentMethod === 'ONLINE' ? "bg-blue-600 text-white" : "bg-white text-gray-400 border border-gray-100"}`}>
                                    ...
                                    <div className={`ml-auto w-5 h-5 rounded-none border-4 flex items-center justify-center ${formData.paymentMethod === 'ONLINE' ? "border-blue-600 bg-white" : "border-gray-200"}`}>
                                        {formData.paymentMethod === 'ONLINE' && <div className="w-1.5 h-1.5 bg-blue-600 rounded-none" />}
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="lg:hidden mt-10">
                            <button
                                type="submit"
                                className="w-full bg-blue-600 hover:bg-black text-white font-black py-5 rounded-none transition-all shadow-2xl uppercase tracking-[0.2em] text-xs"
                            >
                                Place My Order Now
                            </button>
                        </div>
                ...
                <div className="lg:w-1/3">
                    <div className="bg-gray-900 rounded-none p-10 text-white sticky top-40 shadow-2xl border border-gray-800 space-y-8">
                        <div>
                        ...
                        <div className="space-y-6 pt-4 border-t border-gray-800/50">
                            ...
                            <div className="flex justify-between items-center text-xs">
                                ...
                                <span className="text-[10px] font-black text-green-500 uppercase tracking-widest italic bg-green-500/10 px-3 py-1 rounded-none">FREE</span>
                            </div>
                            ...
                            <div className="flex justify-between items-end">
                                <div className="flex flex-col">
                                    <span className="text-[8px] font-black uppercase tracking-[0.3em] text-blue-400">To Pay</span>
                                    <span className="text-[10px] font-bold text-gray-500 uppercase italic">Inclusive of GST</span>
                                </div>
                                <span className="text-3xl font-black text-blue-600 tracking-tighter italic">₹{subtotal.toLocaleString()}</span>
                            </div>
                        </div>
