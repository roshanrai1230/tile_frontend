            ...
            <div className="max-w-[1250px] mx-auto px-4 text-center">
                ...
                <form className="max-w-md mx-auto flex flex-col sm:flex-row gap-4">
                    <input
                        ...
                        className="flex-1 px-6 py-4 rounded-xl outline-none focus:ring-2 focus:ring-[#1a1a1a] text-[#1a1a1a] font-medium"
                    />
                    <button className="px-8 py-4 bg-[#1a1a1a] text-white font-bold rounded-xl hover:bg-black transition-colors uppercase text-sm tracking-widest shadow-xl">
                        Subscribe
                    </button>
                </form>
            </div>
