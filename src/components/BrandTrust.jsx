...
const features = [
    {
        icon: <HiOutlineSparkles className="text-4xl text-orange-500" />,
        title: "Premium Quality",
        description: "Finest grade ceramic and stone sourced for durability and shine."
    },
    {
        icon: <HiOutlineShieldCheck className="text-4xl text-orange-500" />,
    ...
    {
        icon: <HiOutlineCheckBadge className="text-4xl text-orange-500" />,
            ...
            <div className="max-w-[1250px] mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-extrabold mb-4 uppercase tracking-tighter">
                        Why Choose <span className="text-orange-500">My Tiles?</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    {features.map((feature, index) => (
                        <div key={index} className="flex flex-col items-center text-center group">
                            <div className="mb-6 p-5 bg-white/5 rounded-2xl transition-all duration-300 group-hover:bg-white/10 group-hover:scale-110">
                                {feature.icon}
                            </div>
